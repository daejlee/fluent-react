...
![9791169213318](https://github.com/user-attachments/assets/287803b4-fa08-4af9-9789-098d8759cb80)
...
<tr>
  ...
  <td align="center">
    <img src="https://github.com/Ludovico7.png?size=100" width="120px" height="120px"/><br/>
    <a href="https://github.com/Ludovico7">민연규</a>
  </td>
  <td align="center">
...
| 회차 | 일시 | 목차                                             |
| ---- | ---- | ------------------------------------------------ |
| 1    | 1/22 | 1. 입문자를 위한 지식 (~70p)                     |
| 2    | 1/29 | 2. JSX ~ 3. 가상 DOM (~116p)                     |
| 3    | 2/5  | 4. 재조정 ~ 5.2. useMemo를 사용한 메모화 (~164p) |
| 4    | 2/12 | 5.3. 지연 로딩 ~ 5.8. 미리보기 (~204p)           |
| 5    | 2/26 | 6. 서버 사이드 리액트 (~244p)                    |
| 6    | 3/5 | 7. 리액트 동시성 (~282p)                         |
| 7    | 3/12  | 8. 프레임워크 (~322p)                            |
| 8    | 3/19 | 9. 리액트 서버 컴포넌트 (~354p)                  |
| 9    | 3/26 | 10. 리액트 대체제 ~ 11. 마치며 (~395p)           |
